            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading center-text">
                        <h2 class="panel-title">Datos de la institución ${institution.name}</h2>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" id="institution-detail-form">
                            <div class="form-group">
                                <label class="col-sm-3" control-label for="name">Nombre de institución:</label>
                                <div class="col-sm-9">
                                    <input disabled type="text" autofocus required id="name"
                                ...
                                <div class="col-sm-9">
                                    <input disabled type="text" required id="phone"
                                           ...
                                           class="form-control" value="${institution.phoneNumber}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3" for="key">Clave:</label>
                                <div class="col-sm-9">
                                    <input disabled type="text" required id="key"
                                           placeholder="Clave"
                                           class="form-control" value="${institution.key}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3" for="system_commission">Comisión del sistema:</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group" id="multiselect_div" ng-controller="multiselect">
                                <div class="col-sm-2">
                                    <button type="button" id="multiselect_move_up" class="btn btn-block" disabled><i class="glyphicon glyphicon-arrow-up"></i></button>
                                    <button type="button" id="multiselect_move_down" class="btn btn-block" disabled><i class="glyphicon glyphicon-arrow-down"></i></button>
                                </div>
                                <div class="col-sm-4 center-text">
                                    <select name="from[]" id="multiselect_to" class="form-control" size="8" multiple="multiple" disabled sort="false">
                                        <c:forEach items="${workbenches.activeWorkbenchs}" var="inst">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" id="multiselect_rightAll" class="btn btn-block" disabled><i class="glyphicon glyphicon-backward"></i></button>
                                    <button type="button" id="multiselect_rightSelected" class="btn btn-block" disabled><i class="glyphicon glyphicon-chevron-left"></i></button>
                                    <button type="button" id="multiselect_leftSelected" class="btn btn-block" disabled><i class="glyphicon glyphicon-chevron-right"></i></button>
                                    <button type="button" id="multiselect_leftAll" class="btn btn-block" disabled><i class="glyphicon glyphicon-forward" ></i></button>
                                </div>

                                <div class="col-sm-4">
                                    <select name="to[]" id="multiselect" class="form-control" size="8" multiple="multiple" disabled>
